...
exports.cadastrarPedido = async (req, res) => {
    ...
    try {
        ...
        const subTotalPedido = await pedidoModel.calcularSubtotalPedido(idProdutosPedidos, quantProdutos);
        ...
        // Cadastra o pedido
        const idPedido = await pedidoModel.cadastrarPedido(ID_Cliente, subTotalPedido, totalPedido, desconto, entregaNecessaria, tipoPagamento, horaInicio);

        // Cadastra os itens do pedido
        await pedidoModel.cadastrarItensPedido(idPedido, idProdutosPedidos, quantProdutos);
...
exports.buscarPedidosClientes = async (req, res) => {
    try {
        ...
        const pedidosCliente = await pedidoModel.buscarPedidosPorCliente(ID_Cliente);
